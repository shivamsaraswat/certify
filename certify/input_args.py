...
def parse_arguments() -> argparse.Namespace:
    ...
    group1.add_argument('-d', '-host', type=str, metavar='hostname', required=True, help='target host to scan')
    group1.add_argument('-l', '-list', type=argparse.FileType('r'), metavar='file_path', action='store', dest='file', help='target list to scan')
    ...
    group2.add_argument('-av', '-authority-verification', action='store_true', help='display certificate authority verification')
